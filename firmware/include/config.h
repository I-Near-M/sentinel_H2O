...
// ============================================================================
// Cambiar según el nodo a flashear: NODO-01-CABECERA, NODO-02-CONDUCCION, NODO-03-PARCELA
#define NODE_ID "NODO-03-PARCELA"
#define NODE_API_KEY "hash_key_parcela_secure_03"

// ============================================================================
// 2. CONFIGURACIÓN DEL SERVIDOR Y ENDPOINT
// ============================================================================
// IP pública de tu VPS o servidor backend (ej: "192.168.1.100" o "api.sentinel-h2o.pe")
...
// ============================================================================
// 4. CONFIGURACIÓN GPRS (OPERADORES DE PERÚ)
// ============================================================================
// Claro: "claro.pe", Entel: "entel.pe", Movistar: "movistar.pe", Bitel: "bitel.pe"
#define GPRS_APN            "claro.pe"
...
// ============================================================================
// Factor de calibración: con divisor 10k y 20k conectado a 3.3V simula 12.5V de batería
#define BATTERY_DIVIDER_FACTOR 5.7000f
